...
with tf.Session() as sess:
    ...
    if do_train == 0:
        saver.restore(sess, 'save/nets/cnn_mnist_basic.ckpt-'+str(training_epochs-1))
        test2_feeds = {x:testimg,y:testlabel,keepratio:1.0}
        print(sess.run(_accr,feed_dict=test2_feeds))
